...
def generate_trade_subscription(symbol, params={"binary": False}):
    ...
    subs = BybitSubscriptionModelV1(
        topic="trade", symbol=symbol, params=params, event="sub"
    )

    return subs


def generate_trade_subscription_pool(
    symbols: List[str], params={"binary": False}
